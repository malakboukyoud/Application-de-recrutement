...
class CandidatRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'id_diplome' => ['nullable', 'integer', Rule::exists('referentiels', 'id_ref')->where('type_ref', 'DIPLOME')],
            'id_specialite' => ['nullable', 'integer', Rule::exists('referentiels', 'id_ref')->where('type_ref', 'SPECIALITE')],
